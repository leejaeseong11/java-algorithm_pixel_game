        ...
        for (int row = 0; row < PixelTester.SIZE_OF_BOARD; row++) {
            for (int col = 0; col < PixelTester.SIZE_OF_BOARD; col++) {
                if (isPossible(row, col)) {
                    // 상대돌을 발견할 경우 'ㄱ'모양 분석
                    // 다음과 같은 돌모양을 기준으로 함
                    if (col > 0 && row < 7) { // 모양을 만들 수 없는 경우를 제외
    ...
    boolean OneMoreAnalysis(int inputRow, int inputCol, String opt) {
        ...
        if(opt.equals("row")) {
            ...
            for (int i = 0; i < PixelTester.SIZE_OF_BOARD; i++) {
                ...
                if (inputRow != 0 && i != 0 && (inputRow != 1 && i != 1) && (inputRow != 1 && i != 7) && (inputRow != 7 && i != 7)) {
                ...
                if (inputRow != 7 && i != 0 && (inputRow != 0 && i != 1) && (inputRow != 0 && i != 7) && (inputRow != 6 && i != 7)) {
                ...
                if (inputRow != 7 && i != 7 && (inputRow != 0 && i != 0) && (inputRow != 0 && i != 6) && (inputRow != 6 && i != 6)) {
                ...
                if (inputRow != 0 && i != 0 && (inputRow != 1 && i != 1) && (inputRow != 7 && i != 1) && (inputRow != 7 && i != 7)) {
                    if (map[inputRow][i] == 0 && map[inputRow][i - 1] == enemy && map[inputRow - 1][i - 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                ...
                if (inputRow != 0 && i != 7 && (inputRow != 1 && i != 0) && (inputRow != 7 && i != 0) && (inputRow != 7 && i != 6)) {
                    if (map[inputRow][i] == 0 && map[inputRow - 1][i] == enemy && map[inputRow][i + 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                ...
                if (inputRow != 7 && i != 7 && (inputRow != 0 && i != 0) && (inputRow != 6 && i != 0) && (inputRow != 6 && i != 6)) {
                    if (map[inputRow][i] == 0 && map[inputRow + 1][i] == enemy && map[inputRow + 1][i + 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                ...
                // '\' 자 중 오른쪽 아래 돌이 비어있을 경우
                    if ((inputRow != 0 && inputRow != 1) && (i != 0 && i != 1) && (inputRow != 2 && i != 2) && (inputRow != 7 && i != 7)) {
                    ...
                    if ((inputRow != 0 && inputRow != 7) && (i != 0 && i != 7) && (inputRow != 1 && i != 1) && (inputRow != 6 && i != 6)) {
                        if (map[inputRow][i] == 0 && map[inputRow - 1][i - 1] == enemy && map[inputRow + 1][i + 1] == enemy) {
                            myMap[inputRow][inputCol] = 0;
                            return true;
                        }
                    }
                    // '\' 자 중 왼쪽 위 돌이 비어있을 경우 기준
                    if ((inputRow != 6 && inputRow != 7) && (i != 6 && i != 7) && (inputRow != 5 && i != 5) && (inputRow != 0 && i != 0)) {
                        if (map[inputRow][i] == 0 && map[inputRow + 1][i + 1] == enemy && map[inputRow + 2][i + 2] == enemy) {
                            myMap[inputRow][inputCol] = 0;
                            return true;
                        }
        ...
        // 내가 이번 턴 col 중 한 곳에 두었을 경우 이에 대한 행을 탐색
            ...
            for (int i = 0; i < PixelTester.SIZE_OF_BOARD; i++) {
                ...
                // 'ㄱ' 자 3 가지 모양 탐색
                // 'ㄱ' 자 중 오른쪽 아래 돌이 비어있을 경우 기준(기본모양 조건 + 만들어지지않는 모양 조건)
                if (i != 0 && inputCol != 0 && (i != 1 && inputCol != 1) && (i != 1 && inputCol != 7) && (i != 7 && inputCol != 7)) {
                ...
                // 'ㄱ' 자 중 중앙 돌이 비어있을 경우 기준
                if (i != 7 && inputCol != 0 && (i != 0 && inputCol != 1) && (i != 0 && inputCol != 7) && (i != 6 && inputCol != 7)) {
                ...
                // 'ㄱ' 자 중 왼쪽 위 돌이 비어있을 경우 기준
                if (i != 7 && inputCol != 7 && (i != 0 && inputCol != 0) && (i != 0 && inputCol != 6) && (i != 6 && inputCol != 6)) {
                ...
                // 'ㄴ' 자 3 가지 모양 탐색
                // 'ㄴ' 자 중 오른쪽 아래 돌이 비어있을 경우 기준(기본모양 조건 + 만들어지지않는 모양 조건)
                if (i != 0 && inputCol != 0 && (i != 1 && inputCol != 1) && (i != 7 && inputCol != 1) && (i != 7 && inputCol != 7)) {
                    if (map[i][inputCol] == 0 && map[i][inputCol-1] == enemy && map[i - 1][inputCol - 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                ...
                // 'ㄴ' 자 중 중앙 돌이 비어있을 경우 기준
                if (i != 0 && inputCol != 7 && (i != 1 && inputCol != 0) && (i != 7 && inputCol != 0) && (i != 7 && inputCol != 6)) {
                    if (map[i][inputCol] == 0 && map[i - 1][inputCol] == enemy && map[i][inputCol + 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                ...
                // 'ㄴ' 자 중 왼쪽 위 돌이 비어있을 경우 기준
                if (i != 7 && inputCol != 7 && (i != 0 && inputCol != 0) && (i != 6 && inputCol != 0) && (i != 6 && inputCol != 6)) {
                    if (map[i][inputCol] == 0 && map[i+1][inputCol] == enemy && map[i + 1][inputCol + 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                ...
                // '\' 자 3 가지 모양 탐색
                // '\' 자 중 오른쪽 아래 돌이 비어있을 경우
                if ((i != 0 && i != 1) && (inputCol != 0 && inputCol != 1) && (i != 2 && inputCol != 2) && (i != 7 && inputCol != 7)) {
                ...
                // '\' 자 중 중앙 돌이 비어있을 경우 기준
                if ((i != 0 && i != 7) && (inputCol != 0 && inputCol != 7) && (i != 1 && inputCol != 1) && (i != 6 && inputCol != 6)) {
                    if (map[i][inputCol] == 0 && map[i - 1][inputCol - 1] == enemy && map[i + 1][inputCol + 1] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
                }
                // '\' 자 중 왼쪽 위 돌이 비어있을 경우 기준
                if ((i != 6 && i != 7) && (inputCol != 6 && inputCol != 7) && (i != 5 && inputCol != 5) && (i != 0 && inputCol != 0)) {
                    if (map[i][inputCol] == 0 && map[i + 1][inputCol + 1] == enemy && map[i + 2][inputCol + 2] == enemy) {
                        myMap[inputRow][inputCol] = 0;
                        return true;
                    }
